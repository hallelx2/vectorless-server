module github.com/hallelx2/vectorless-server
...
require (
	...
	github.com/hallelx2/vectorless-engine v0.0.0
...
// During development, point at the local engine checkout.
// Remove this line once the engine is published to a registry.
replace github.com/hallelx2/vectorless-engine => ../vectorless-engine
